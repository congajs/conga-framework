 ...
 */
function RoutingAnnotationHandler() {
	this._routes = {};
}
...
RoutingAnnotationHandler.prototype = {
    ...
    /**
	 * Cached resolved routes to filePath
	 * @type {Object}
	 * @private
     */
	_routes: {},
	...
	parseRoutesFromFile: function(container, reader, controller){
		...
		if (controller.filePath in this._routes) {
			return this._routes[controller.filePath];
		}
		...
		this._routes[controller.filePath] =  { routes: routes, websocketRoutes: websocketRoutes };

		return this._routes[controller.filePath];
	},


	constructor: RoutingAnnotationHandler,
};
