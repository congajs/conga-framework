...
module.exports = class BuildKernel extends Kernel {
    ...
    build(args, options, cb) {
        ...
        const targetConfig = loader.load(
        ...
        //console.log(targetConfig);process.exit();

        this.container.get('conga.builder').build(
            new Config(targetConfig.parameters['bundles.config']),
            cb
        );
    }
}
