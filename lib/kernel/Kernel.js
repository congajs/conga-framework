...
module.exports = class Kernel {
    ...
    boot(cb) {
        ...
        Loader.init(this.environment === 'development');
    ...
    processConfigurations(container, cb) {
        ...
        async.series(calls, function(err, results) {
            ...
            const Config = Loader.require(path.resolve(__dirname, '../config/Config'), '@conga/framework');
    ...
    createBundleFinder(config) {
        const BundleFinder = Loader.require(path.join(__dirname, '..', 'bundle', 'BundleFinder'), '@conga/framework');
