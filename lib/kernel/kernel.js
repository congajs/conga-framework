...
Kernel.prototype = 
{
	...
	boot: function(cb){
		...
		GLOBAL.Conga = {
			...
			/**
			 * This class allows you to inherit from a super class while providing the prototype (class body) in one call
			 *
			 * <code>
			 *     function myClass() {
			 ...
			 *     }
			 *
			 *     Conga.inherits(myClass, superClass, {
			 *
			 ...
			 * @return {void}
			 */
			inherits: function(childClass, superClass, proto) {
