...
Loader.prototype = {
	...
	load: function(projectPath, app, environment, defaults){
		...
		//console.log(this.config.parameters['bundles.config'].pubsub);
	...
	findBundlePaths: function(){
		...
		var projectBundleDir = path.join(this.projectPath, 'bundles');
	...
	loadAppConfig: function(){
		...
		this.setParameter('app.config', appConfig.app);
		this.setParameter('app.bundles', appConfig.bundles);
		this.setParameter('app.session', appConfig.session);
