    ...
    mergeDefaults() {
        ...
        for (var bundle in bundlePaths) {
            ...
            if (fs.existsSync(defaultConfigPath)) {
                ...
                let bundleConfigHandlerPath = path.join(baseBundleConfigHandlerPath, 'Configuration');

                if (!fs.existsSync(bundleConfigHandlerPath)) {
                    bundleConfigHandlerPath = path.join(baseBundleConfigHandlerPath, 'configuration');
                }
